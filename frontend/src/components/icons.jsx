// Εικονίδια σε inline SVG (στυλ Lucide) - δεν χρειάζεται καμία εξωτερική βιβλιοθήκη
...
export function Logo({ size = 36 }) {
  return <img src="/logo.png" alt="Ktisis" width={size} height={size} style={{ objectFit: "contain" }} />;
}
