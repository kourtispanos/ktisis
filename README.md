...
- **Απλή χρήση:** κατέβασε το **[⬇️ KtisisSetup.exe](https://github.com/kourtispanos/ktisis/releases/latest/download/KtisisSetup.exe)**,
  άνοιξέ το και η εφαρμογή ανοίγει μόνη της στον browser σου. Δεν χρειάζεται
  τίποτα άλλο εγκατεστημένο, ούτε δικαιώματα διαχειριστή.
